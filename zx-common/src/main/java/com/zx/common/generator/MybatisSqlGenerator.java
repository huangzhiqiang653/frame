package com.zx.common.generator;
...
public class MybatisSqlGenerator {
    // 全局配置
    final static String GLOBAL_PATH = "/src/main/java";
    final static String AUTHOR = "黄智强";
    final static String MODEL_NAME = "auth";
    final static String TABLE_PRE = "auth_";
    // 数据库配置
    final static String DB_URL = "jdbc:mysql://127.0.0.1:3306/frame_db?useUnicode=true&useSSL=false&characterEncoding=utf8";
    final static String DB_DRIVER = "com.p6spy.engine.spy.P6SpyDriver";
    final static String DB_USERNAME = "root";
    final static String DB_PASSWORD = "root";
    // 包配置
    final static String PACKAGE_ROOT = "com.iflytek";
    final static String MAPPER_PATH = "/src/main/resources/mapper/";
    // 实体类集成的公共基础类
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // 写于父类中的公共字段
        strategy.setSuperControllerClass("com.zx.frame.common.BaseController");
        strategy.setSuperEntityClass("com.zx.frame.common.BaseSimpleEntityBean");
        //strategy.setSuperEntityClass("com.zx.frame.common.BaseEntityBean");
