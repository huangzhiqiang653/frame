 ...
 */
@Service
public class RtRecordPumpServiceImpl extends ServiceImpl<RtRecordPumpMapper, RtRecordPump> implements IRtRecordPumpService {
    ...
    public ResponseBean addBatch(RequestBean requestBean) {
        return new ResponseBean(this.saveBatch(BaseHzq.convertValue(requestBean.getInfos(), RtRecordPump.class)));
    }
    ...
    public ResponseBean updateAllField(RequestBean requestBean) {
        return new ResponseBean(this.updateById(BaseHzq.convertValue(requestBean.getInfo(), RtRecordPump.class)));
    }
    ...
    public ResponseBean updateAllFieldBatch(RequestBean requestBean) {
        return new ResponseBean(this.updateBatchById(BaseHzq.convertValue(requestBean.getInfos(), RtRecordPump.class)));
    }
