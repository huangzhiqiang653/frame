...
DROP TABLE IF EXISTS t_rt_manage_area;/*SkipError*/
CREATE TABLE t_rt_manage_area
(
    id          VARCHAR(64) NOT NULL COMMENT '主键',
    target_id   VARCHAR(64) COMMENT '车辆或人员主键',
    org_id      VARCHAR(64) COMMENT '行政区划主键',
    org_code    VARCHAR(64) COMMENT '行政区划编码',
    create_time DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    creator     VARCHAR(64) COMMENT '创建人',
    update_time DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
    delete_flag INT         NOT NULL DEFAULT 0 COMMENT '删除标记 0未删除(默认)，1删除',
