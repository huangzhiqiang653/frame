    ...
    <div class="main-area">
        ...
        >
            ...
            <el-row>
                ...
                <el-col :span="8">
                    <el-form-item label="律所名称：" prop="lawFirmName" :rules="outsideLawyerYes?formRules.lawFirmName:[{required: false, message: '律所名称不可为空', trigger: 'blur'}]">
                        <el-input v-model="formData.lawFirmName" placeholder="律所名称" maxlength="64"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="律师姓名：" prop="lawerName" :rules="outsideLawyerYes?formRules.lawerName:[{required: false, message: '律师姓名不可为空', trigger: 'blur'}]">
