...
public class MybatisSqlGenerator {
    // 全局配置
    final static String GLOBAL_PATH = "/auth/src/main/java";
    final static String AUTHOR = "黄智强";
    final static String MODEL_NAME = "auth";
    final static String TABLE_PRE = "auth_";
    // 数据库配置
    final static String DB_URL = "jdbc:mysql://127.0.0.1:3306/zx_frame_db?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    final static String MAPPER_PATH = "/auth/src/main/resources/mapper/";
    // 实体类集成的公共基础类
